...
// To parse this data:
//
//   import { Convert, MoreInformationPokemon } from "./file";
//
//   const moreInformationPokemon = Convert.toMoreInformationPokemon(json);

export interface MoreInformationPokemon {
...
// To parse this data:
//
//   import { Convert, EvolutionDetail } from "./file";
//
//   const evolutionDetail = Convert.toEvolutionDetail(json);
...
export interface Chain {
  evolution_details: EvolutionDetailElement[];
  evolves_to: Chain[];
  is_baby: boolean;
  species: Species;
}

export interface EvolutionDetailElement {
  gender: null;
  held_item: null;
  item: null;
  known_move: null;
